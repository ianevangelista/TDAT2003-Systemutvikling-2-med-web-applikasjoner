...
$sql="SELECT * FROM gjenstand WHERE CURRENT_TIMESTAMP<utlopsdato";
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="bakgrunn">
                ...
                <div class="caption">
                    <span class="border">ALLE AUKSJONER</span>
                </div>
            </div>

            <div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">

                <h3 style="text-align:center;">Alle auksjoner</h3>
