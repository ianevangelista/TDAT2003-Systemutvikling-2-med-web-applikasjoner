    ...
    <body>
        <div class="wrapper">
            ...
            <div class="bakgrunn">
                ...
                <div class="caption">
                    <span class="border">GJENSTANDSBEKREFTELSE</span>
                </div>
            </div>

            <div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;"></div>

                <h3 style="text-align:center;">BEKREFTELSE AV REGISTRERING AV GJENSTAND</h3>
            <h1>Din registrering er blitt lagt til i databasen</h1>
            <p>Du kan oppdatere se alle auksjoner <a href="alleauksjoner.php">her </a></p>
