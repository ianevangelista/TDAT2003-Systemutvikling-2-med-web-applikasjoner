<?php
    ...
    {
        $sql = sprintf("INSERT INTO band(bandnavn) VALUES ('%s')",
                       $tilkobling->real_escape_string($_POST["txtBandnavn"])
                      );
        $tilkobling->query($sql);
        
        header("Location: bekreftelse_band.php");
    }
?>
...
<html>
    <head>
        ...
        <title>Registrering av band</title>
            ...
            <main>
                ...
                <article>
                    ...
                    <form action="" method="post">
                        <label for="txtBandnavn">Bandnavn:</label>
                        <input type="text" name="txtBandnavn" id="txtBandnavn" />
                        <br>
                        <br>
                        <button type="submit" name="submit">Registrer band</button>
                    </form>
