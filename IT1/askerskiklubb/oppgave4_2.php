<?php
    ...
    $sql= sprintf("SELECT loype.idloype, utover.idutover, utover.fornavn, utover.etternavn, testlop.tid FROM loype, utover, testlop WHERE utover.idutover=testlop.idutover AND loype.idloype=testlop.idloype AND testlop.idloype=%s ORDER BY idutover, idloype, tid",
