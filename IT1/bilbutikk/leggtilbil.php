...
{
    $sql =sprintf("INSERT INTO bil(merke, selgerid, farge, arsmodell, pris) VALUES ('%s', %s, '%s', '%s', '%s')",
    ...
    <body>
        ...
        <table>
         ...
         <?php } ?>
                ...
                <tr>
                    <td colspan="2"><button type="submit" name="submit">Legg til bil</button></td>
                </tr>
            </form>
        </table>
